...
export const Streaming: React.FC = () => {
  ...
  const isAuthorized = ['visitante', 'acceso', 'artista', 'admin'].includes(currentRole);
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground">
            Solo los visitantes, el personal de acceso, artistas y administradores pueden acceder al streaming.
          </p>
        </div>
      </div>
    );
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Button 
                      ...
                      className="flex-1"
                      onClick={() => handleWatchStream(stream.id)}
                      disabled={stream.accessType === 'premium' && (currentRole === 'visitante' || currentRole === 'acceso')}
                    >
                      <Play className="h-3 w-3 mr-2" />
                      {stream.accessType === 'premium' && (currentRole === 'visitante' || currentRole === 'acceso') 
                        ? 'Requiere Premium'
                        : 'Ver Stream'
                      }
                    </Button>
